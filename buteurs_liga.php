...
//<a href='classement_premier_league.php'></a>
    ...
    <table class='table  mx-auto table-hover' style=' width:50%;'>
        <tbody >
            ...
            <tr>
                <td scope='col'  style='text-align:center;'><a href='classement_liga.php' class='text-dark'>Classement</a></th>
                <td scope='col' class='text-white bg-secondary col-6' style='text-align:center; '><a href='buteurs_liga.php' class='text-white'>buteurs_liga</a></th>     
            </tr>
            </a>
        </tbody>
    </table>
